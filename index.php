            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="admin/login.php" target="_blank">Admin</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mr-auto text-center">
                        ...
                        <p class="d-block" href="<?php echo $_SESSION['setting_email'] ?>"><?php echo $_SESSION['setting_email'] ?></p>
                    </div>
                </div>
            </div>
            <br>
